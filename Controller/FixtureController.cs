...
namespace ofisprojesi
{
    ...
    public class FixtureController : ControllerBase
    {
        ...
        [Route("")]
        [HttpGet]
        public ActionResult GetFixtureByName([FromQuery] string fixturename, fixtureservicesenum? status, [FromQuery] int pagecount, [FromQuery] int pageindex,[FromQuery] criteria criteria,DateTime? start, DateTime? end)
        {
            try
            {
                ResultDto fixture = _fixtureservices.GetFixtureByName(fixturename, status,pagecount,pageindex, criteria,start,end);
